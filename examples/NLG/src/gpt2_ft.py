...
parser.add_argument('--nola_rank', type=int, default=8, help='nola decomposition rank')

parser.add_argument('--nola_c', type=float, default=1.0, help='nola scale')

parser.add_argument('--nola_qv', action='store_true', help="Apply nola to query and value")

parser.add_argument('--nola_mlp', action='store_true', help="Apply nola to mlp")
...
if __name__ == '__main__':
    ...
    if args.model_card == 'gpt2.sm':
        config = GPT2Config(
            ...
            nola_rank=args.nola_rank, 
            nola_qv=args.nola_qv, 
            nola_mlp=args.nola_mlp, 
            nola_c=args.nola_c, 
            qnola=args.qnola, 
            qbits=args.qbits,
        )
