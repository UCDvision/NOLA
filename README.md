...
Next, please use the corresponding scripts to fine-tune LLaMA models with NOLA. For instance, to fine-tune LLaMA-2 70B on the Alpaca dataset, execute the following script.
